...
VALUES ('Собеседование в IT компании', STR_TO_DATE('10.02.2019', '%d.%m.%Y'), 3, 1, 0),
       ...
       ('Вывести проект и задачи текущего пользователя', STR_TO_DATE('16.02.2019', '%d.%m.%Y'), 6, 4, 0),
       ('Использовать подготовленные выражения', STR_TO_DATE('16.02.2019', '%d.%m.%Y'), 6, 4, 0),
       ('Составить планы на неделю', STR_TO_DATE('16.02.2019', '%d.%m.%Y'), 7, 4, 0),
       ('Составить планы на месяц', STR_TO_DATE('20.02.2019', '%d.%m.%Y'), 7, 4, 0),
       ('Составить планы на три месяца', STR_TO_DATE('28.02.2019', '%d.%m.%Y'), 7, 4, 0);
